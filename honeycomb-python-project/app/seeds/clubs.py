...
def seed_club():
    club1 = Club(name='Film-a-holics', description='Interested in films?',
                 img_url='https://i.imgur.com/GDR0jSs.jpg', category_id=1, host_id=1, school_id=1)
    club2 = Club(name='Food Club', description='no vegans allowed',
                 img_url='https://i.imgur.com/j2a9XP7.jpg', category_id=2, host_id=2, school_id=1)
    ...
    club9 = Club(name='Theater Club', description='To join or not to join, that is the question... its to join',
                 img_url='https://schools.risd.org/cms/lib/TX01818237/Centricity/Domain/972/Comedy_and_tragedy_masks_without_background.svg.png', category_id=1, host_id=3, school_id=1)
    club10 = Club(name='Baking Club', description='Join us to get mad bread!',
                  img_url='https://www.vegrecipesofindia.com/wp-content/uploads/2021/01/bread-recipe-1.jpg', category_id=2, host_id=1, school_id=1)
    ...
    club13 = Club(name='Debate Club', description='The chicken or the Egg? Come find out!',
                  img_url='https://upload.wikimedia.org/wikipedia/en/thumb/6/61/Debate_Logo.svg/1559px-Debate_Logo.svg.png', category_id=7, host_id=1, school_id=1)

    # Adding club host as member of club:
    # add and commit all clubs to database
    allClubs = [club1, club2, club3, club4, club5, club6, club7,
                club8, club9, club10, club11, club12, club13]
    ...
    user2Clubs = [club2, club5, club8, club11]
