...
def seed_club():
    club1 = Club(name='Food Club', description='No vegans allowed', img_url='https://i.imgur.com/GDR0jSs.jpg', category_id=1, host_id=1, school_id=1)
    club2 = Club(name='Film-a-holics', description='Interested in films? Love watching classics? Join us!', img_url='https://i.imgur.com/j2a9XP7.jpg', category_id=1, host_id=1, school_id=1)
